                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            ...
                                            @else
                                                <input type="hidden" name="id_assigned_equipment"
                                                    value="{{ $employee->equipment->equipment_id }}">
                                                <input type="text" class="form-control"
                                                    value="{{ $employee->equipment->model_name }}  {{ $employee->equipment->serial }}"
                                                    readonly disabled>
                                            @endif
                                        </div>
                                    </div>
                                    @livewire('update-equipment', ['employee' => $employee])
                                    <div class="row mb-4">
                                        <div class="col-md-6">
